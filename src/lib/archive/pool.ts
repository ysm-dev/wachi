...
export const createArchivePool = () => {
  ...
  const trackArchive = (task: () => Promise<void>): void => {
...
const defaultArchivePool = createArchivePool();

export const trackArchive = defaultArchivePool.trackArchive;
export const flushArchivePool = defaultArchivePool.flushArchivePool;
export const resetArchivePoolForTest = defaultArchivePool.resetArchivePoolForTest;
